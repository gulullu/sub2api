...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	cyberFeedbackService := securityaudit.NewCyberFeedbackService(postgreSQLRepository, redisClient, configConfig, notificationEmailService, settingRepository, promptService, promptService)
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, pluginManager, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, configConfig, coordinator, cyberFeedbackService)
