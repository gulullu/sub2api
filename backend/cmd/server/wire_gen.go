...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	cyberFeedbackService := securityaudit.NewCyberFeedbackService(postgreSQLRepository, redisClient, configConfig, notificationEmailService, settingRepository, promptService)
