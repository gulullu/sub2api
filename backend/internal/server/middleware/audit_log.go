...
var auditExtraAllowedKeys = map[string]struct{}{
	...
	"group_id": {}, "exemption_id": {}, "user_id": {}, "api_key_id": {},
	"interval_seconds": {}, "policy_version": {},
}
...
var auditSensitiveReads = map[string]string{
	...
	"GET /api/v1/admin/prompt-audit/cyber/events/:id/evidence":            "admin.prompt_audit.cyber.evidence.read",
	"GET /api/v1/admin/prompt-audit/probe-governance/events/:id":          "admin.prompt_audit.probe.event_detail.read",
	"GET /api/v1/admin/prompt-audit/probe-governance/events/:id/evidence": "admin.prompt_audit.probe.event_evidence.read",
}
...
var auditBodyOmittedRoutes = map[string]struct{}{
	...
	"POST /api/v1/admin/prompt-audit/cyber/events/:id/adopt":                            {},
	...
	"PUT /api/v1/admin/prompt-audit/probe-governance/groups/:groupID":                   {},
	"POST /api/v1/admin/prompt-audit/probe-governance/events/:id/clear":                 {},
	"POST /api/v1/admin/prompt-audit/probe-governance/groups/:groupID/exemptions":       {},
	"DELETE /api/v1/admin/prompt-audit/probe-governance/groups/:groupID/exemptions/:id": {},
}
