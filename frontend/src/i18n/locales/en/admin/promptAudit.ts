export default {
  promptAudit: {
    ...
    cyber: {
      ...
      description: 'Review confirmed upstream CYB signals and turn safe, abstract patterns into audit rules. This workspace never exposes raw prompts, hashes, users, keys, or account names.',
      ...
      safePreview: 'Redacted preview', safePreviewHint: 'Only the server-produced redacted excerpt is shown. Raw input and prompt hashes are not returned to this page.', safeMetadata: 'Safe metadata',
      ...
      fields: {
        requestId: 'Request ID', accountId: 'Account ID', groupId: 'Group ID', model: 'Model', endpoint: 'Endpoint', protocol: 'Protocol', stage: 'Stage', transport: 'Transport', upstreamStatus: 'Upstream status',
      ...
      generation: {
        pending: 'The system is generating an abstract candidate rule. No manual summary is required.',
        failed: 'Candidate rule generation failed.', regenerate: 'Regenerate candidate', unknownError: 'candidate_generation_failed',
      },
      adopt: {
      ...
      errors: {
        load: 'Unable to load CYB feedback.', adopt: 'Unable to adopt this rule.', reject: 'Unable to reject this feedback.', revoke: 'Unable to revoke this rule.', regenerate: 'Unable to regenerate the candidate rule.',
