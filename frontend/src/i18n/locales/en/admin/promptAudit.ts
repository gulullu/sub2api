export default {
  promptAudit: {
    ...
    cyber: {
      ...
      metadataGroups: { identity: 'Caller and API Key', accounts: 'Routing and OAuth credential accounts', request: 'Request information', result: 'Upstream result and review record' },
      fields: {
